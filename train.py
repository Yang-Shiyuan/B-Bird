...
for ep in range(0, num_epoch):
    ...
    with torch.no_grad(): # evaluation
        ...
        for i, (x, y) in enumerate(val_dataloader):
            ...
            tqdm_iterator.set_description(f'val_ep={ep}, iter={i}, \
            correct in current iter=: {correct_current_iter}/{val_dataloader.batch_size}, acc (so far)={acc:.2f}')
        ...
        print(f'eval completed at ep={ep:02}, avg_loss={loss_val_mean:.4f}, score={score:.4f} -----------------')
